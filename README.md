# CKEditor 5 feature-rich classic editor

This repository presents a CKEditor 5 classic editor build with most of the free features generated by the [Online builder tool](https://ckeditor.com/ckeditor-5/online-builder). The goal is to provide a custom built feature-rich editor based on the classic editor that you can see [here](https://ckeditor.com/docs/ckeditor5/latest/examples/builds-custom/full-featured-editor.html).
...
```js
import RichClassicEditor from 'ckeditor5-rich-classic-build';
```
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `27z6hwjldkc5-1twvplcm6e2r`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
...
Yes, just import this package as you would import the official classic build package into your project.